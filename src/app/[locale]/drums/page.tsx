...
export default function DrumsPage() {
  ...
  const content = isArabic
    ? {
        paragraph:
          "تُعد الطبول من أقدم الآلات الموسيقية في التاريخ، إذ تعود إلى نحو 6000 قبل الميلاد حين استخدم الإنسان المبكر الجذوع المجوفة وجلود الحيوانات لصنع الإيقاع. وقد ظهرت في ثقافات كثيرة واستخدمت للتواصل والطقوس والموسيقى. وفي أوائل القرن العشرين تطورت مجموعة الطبول الحديثة، فجمعت عدة طبول وصنوج في إعداد واحد. واليوم ما زالت الطبول تمثل نبض الموسيقى، وتؤدي دوراً أساسياً في الجاز والبوب والرقص والموسيقى المعاصرة. 🥁",
        reserveHelper: "احجز تجربتك مع الطبول",
        reserveCta: "احجز الآن",
        roomCta: "هل تريد رؤية غرفة الطبول لدينا؟",
      }
    : {
        paragraph:
          "Drums are among the oldest musical instruments, dating back to around 6000 BCE, when early humans used hollow logs and animal skins to create rhythm. Found in many cultures, they were used for communication, rituals, and music. In the early 20th century, the modern drum kit was developed, combining multiple drums and cymbals into one setup. Today, drums remain the heartbeat of music, essential in styles from jazz and pop to dance and contemporary music. 🥁",
        reserveHelper: "Reserve your drum experience",
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        ...
        <aside
          className="order-1 mt-3 flex w-full max-w-sm self-center flex-col rounded-[1.5rem] border px-3 py-2.5 sm:mt-4 sm:max-w-md sm:px-4 sm:py-3 lg:order-2 lg:mt-6 lg:max-w-[16rem] lg:self-auto lg:sticky lg:top-32"
          style={GLASS_CARD_STYLE}
          dir={isArabic ? "rtl" : "ltr"}
        >
          <p className="mx-auto max-w-[16rem] text-center text-[12px] leading-[1.45rem] text-royal-cream/90 sm:max-w-[19rem] sm:text-[14px] sm:leading-6 lg:max-w-[13rem]">

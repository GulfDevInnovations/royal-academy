...
export default async function OpenBalletPage({
  ...
  return (
    <BalletSubclassPage
      ...
      reservationQuery={{ q: "Open Ballet" }}
      description={{
      ...
      highlights={[
        { en: "Fundamentals with level-based options", ar: "أساسيات مع خيارات حسب المستوى" },
        { en: "Strength, mobility, and control", ar: "قوة ومرونة وتحكم" },
        { en: "Center work and short combinations", ar: "تمارين في الوسط وتركيبات قصيرة" },
      ]}

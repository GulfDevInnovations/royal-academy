...
export default async function BabyBalletPage({
  ...
  return (
    <BalletSubclassPage
      ...
      highlights={[
        {
          en: 'Basic ballet positions and balance',
          ar: 'وضعيات باليه أساسية وتوازن',
        },
        {
          en: 'Musicality and rhythm games',
          ar: 'إحساس بالموسيقى وألعاب إيقاع',
        },
        {
          en: 'Age-appropriate stretching and posture',
          ar: 'تمدد ووقفة مناسبة للعمر',
        },
      ]}
    />
  );

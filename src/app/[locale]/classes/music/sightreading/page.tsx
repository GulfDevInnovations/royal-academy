...
const LESSON_SECTIONS = [
  ...
  },
  {
    ...
    body: [
      'In sight reading class, we train your brain and eyes to understand music quickly.',
    ],
    highlighted: false,
  },
  {
    ...
    ? {
        ...
        sections: [
          ...
          },
          {
            ...
            body: [
              'في حصة القراءة الموسيقية ندرّب عينيك وذهنك على فهم الموسيقى بسرعة.',
            ],
            highlighted: false,
          },
          {
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        {STAFF_ROWS.map((row, index) => (
          <div
            ...
            style={{
              top: `calc(var(--staff-start) + ${index} * var(--staff-row-step))`,
            }}
          >
